...
Decred的发起团队是是开发比特币GO语言版本的Btcsuite / btcd 团队。Decred虽然上线主网已经有3年多了，但普通人对DCR了解的比较少。Decred Staking系列分上下两篇，第一篇介绍Decred PoW/PoS混合机制以及Staking 教程，第二篇探讨Decred staking相对其他PoS项目的优势。 
...
* 花费了初始开发团队约41.5万美元，经过大约2年时间的开发，Decred于2016年2月份正式上线主网。更详细的DCR创立历史可以到[这里](../chapter_0/btc_dcr_history.md)了解。
...
4.  **链下投票，决定如何花费Decred社区基金。**
	  ...
	  Politeia除了决定Decred的发展方向，也是一个讨论如何花费社区基金的平台，把在一般项目中属于开发团队的决定资金安排的那部分权力，下放给整个社区。

### Decred PoS参与者获得30%区块奖励
 
为了参与PoS投票，利益相关者锁定一些DCR以换取票。锁定DCR的数量被称为票价（票价也可以称为Stake难度），每144个块（约12小时）动态调整。每144块（约12小时），Stake难度算法计算新的票价以试图使全网票数维持在40960票左右。当前的票价可以在Decrediton钱包或[区块浏览器](https://explorer.dcrdata.org/)上找到。
...
Decred可能是[治理领域走得最远的项目](../chapter_04/dcr_best_governance.md)
...
#### 相关PoS链接：
* [Decred官方钱包PoS挖矿教程](https://www.chainnode.com/post/282187)
* [如何用CLI命令行钱包购买投票](https://docs.decred.org/wallets/cli/dcrwallet-tickets/)
